...
sentences_test = ['会议充分肯定了2019年金融市场和信贷政策工作取得的成绩，在推动金融市场规范、创新、发展、开放，加大金融支持国家战略和重点领域。',
                  '民营小微企业、精准扶贫力度，稳妥开展互联网金融风险专项整治以及房地产金融宏观审慎管理等方面做了大量卓有成效的工作。', '为实施稳健货币政策、防范化解重大金融风险、推动经济结构调整和转型升级提供了有力支撑。']
...
x, m = data_io.sentences2idx(sentences_test, words)
